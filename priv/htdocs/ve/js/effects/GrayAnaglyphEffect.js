...
THREE.GrayAnaglyphEffect = function ( renderer, width, height ) {
	...
	var _material = new THREE.ShaderMaterial( {
		...
		fragmentShader: [
			...
			"	gl_FragColor = vec4( colorL.r * 0.299 + colorL.g * 0.587 + colorL.b * 0.114, ", 
            "                        colorR.r * 0.299 + colorR.g * 0.587 + colorR.b * 0.114, ", 
            "                        colorR.r * 0.299 + colorR.g * 0.587 + colorR.b * 0.114, ",
            "                        colorL.a + colorR.a); ", 
			"}"
