...
Graph.prototype.addEdge = function(edge) {
  if(edge.source.addConnectedTo(edge.target) === true) {
    this.edgeSet[edge.source.id + edge.target.id] = edge
...
Graph.prototype.getEdge = function(node1_id, node2_id) {
  return this.edgeSet[node1_id + node2_id];
};
